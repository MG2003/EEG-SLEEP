...
def main():
    ...
    parser.add_argument('f99247t23', type=str, help='serial number', default='')
    parser.add_argument('4633', type=int, help='board id, check docs to get a list of supported boards',
                        required=True)
